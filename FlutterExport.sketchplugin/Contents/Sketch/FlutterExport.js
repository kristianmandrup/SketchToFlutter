...
function parseArtboard(context) {
  ...
  // Header
  write(header(artboardName))
  write("")

  // Declarations
  write(declarationsFor(allElements))
...
function declarationsFor(elements) {
  var s = ""
...
function declarationsForSingleText(e) {
